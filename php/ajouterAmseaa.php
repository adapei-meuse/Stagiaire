...
<head>
    <title>Ajouter un nouveau logo</title>
    <meta charset='UTF-8'>
...
<body>
    ...
    if (isset($_POST['submit'])) {
        ...
        if (move_uploaded_file($image_tmp, $target_file)) {
            $sql = "INSERT INTO amseaa (nom, redirection, image) VALUES ('$nom', '$redirection', '$target_file')";
    ...
    <header class="titre text-center py-3">
        ...
        <a href="Amseaa.php" class="btn btn-light"><img src="img/retour.jpg" class="logo-verry-small"></a>
