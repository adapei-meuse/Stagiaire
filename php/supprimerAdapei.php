...
<body>
    ...
    if (isset($_POST['delete'])) {
        ...
        $sql = "SELECT image FROM adapei WHERE id='$id'";
        ...
        $sql = "DELETE FROM adapei WHERE id='$id'";
    ...
    $sql = "SELECT id, nom, image FROM adapei";
    $result = $conn->query($sql);
    ?>
        ...
        <div class="table-responsive">
            <table class="table table-striped table-bordered text-center">
                ...
                if ($result->num_rows > 0) {
                    ...
                    echo '<tr><td colspan="3" class="text-center">Aucun logo disponible</td></tr>';
                }
                $conn->close();
                ?>
            </table>
