...
<body>
    <header class="titre text-center py-3">
        <h1 class="titre">DIOCESE DE VERDUN</h1>
    </header>
    ...
    $sql = "SELECT nom, redirection, image FROM diocese";
    ...
    <div class="container my-4">
        ...
        <?php
            if ($result->num_rows > 0) {
                ...
                echo '<div class="col-12 text-center">Aucun logo disponible</div>';
            }
            $conn->close();
            ?>
        </div>
    ...
    <div class="container text-center my-4">
        <a href="ajouterDiocese.php" class="btn btn-primary mx-2">Ajouter</a>
        <a href="supprimerDiocese.php" class="btn btn-danger mx-2">Supprimer</a>
    </div>
    <br><br><br>
    
    <footer>
        <div class="footer">
            <b>Launchpad V2.0</b> © 2023 DIOCESE DE VERDUN de la Meuse - <a href="https://github.com/adapei-meuse/launchpad">GitHub</a>
        </div>
    </footer>
