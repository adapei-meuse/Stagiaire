...
<body>
    ...
    $sql = "SELECT nom, redirection, image FROM adapei";
    ...
    <div class="container text-center my-4">
        <a href="ajouterAdapei.php" class="btn btn-primary mx-2">Ajouter</a>
        <a href="supprimerAdapei.php" class="btn btn-danger mx-2">Supprimer</a>
    </div>
    <br><br><br>
